...
const firebaseConfig = {
  ...
  project_id: process.env.FIREBASE_PROJECT_ID || "mawashi-bh",
  ...
  client_x509_cert_url: `https://www.googleapis.com/robot/v1/metadata/x509/${process.env.FIREBASE_CLIENT_EMAIL || "firebase-adminsdk-fbsvc@mawashi-bh.iam.gserviceaccount.com"}`,
